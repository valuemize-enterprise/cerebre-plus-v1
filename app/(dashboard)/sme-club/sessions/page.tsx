    ...
    <div style={{ maxWidth:960, margin:'0 auto' }}>
      ...
      <div style={{ marginBottom:24 }}>
        <div style={{ display:'flex', alignItems:'center', gap:8, marginBottom:8 }}>
          ...
          <span style={{ fontSize:11, fontWeight:700, padding:'3px 10px', borderRadius:20, background:`${TEAL}18`, color:TEAL, letterSpacing:'1px', textTransform:'uppercase' }}>✦ SME Club Member</span>
        </div>
      ...
      {/* All sessions are accessible — SME Club is free for everyone */}
