...
import { getFieldSuggestions, detectFieldSemantic } from '@/lib/tools/form-suggestions'
...
import { INDUSTRY_LABEL_MAP } from '@/lib/tools/industries'
      ...
      >
        ...
        {step === 0 && (
          <>
            ...
            <SuggestionStrip
              ...
              label={form.industry ? `Names for ${INDUSTRY_LABEL_MAP[form.industry] || form.industry} businesses` : 'Example business names'}
        ...
        {step === 1 && (
          <>
            ...
            />
            {/* AI-powered: uses business name + industry already filled in step 1 */}
            <AISuggestionStrip
              fieldId="description"
              fieldLabel="What does your business do?"
              fieldSemantic="product_service"
              toolId="onboarding"
              toolName="Cerebre Plus Onboarding"
              existingInputs={{
